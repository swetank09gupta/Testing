...
@ComponentScan({"com.huntingCube.global.resources.configuration"})
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.huntingCube.login.model", "com.huntingCube.dataView.model");
